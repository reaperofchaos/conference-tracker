...
import { type AuthorDropdownOption, type DropdownOption, type PresentationFormProps } from '../types';
import { Box, MenuItem, Select, TextField, Typography } from '@mui/material';
import { type Section } from '../types/Presentation.types';
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
             ...
             <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <DateSelector label="Date" value={date} onChange={(newValue) => { setDate(newValue) }} />
            </Box>
        </Box>)
}
